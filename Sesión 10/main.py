...
# Si el archivo está en el mismo directorio qu este script, solo necesitas el nombre del archivo.
path = 'Online_Retail.csv'

# Lee el archivo CSV usando la función read_csv de pandas.
# Se especifíca la codificación latín 1 para manejar caracteres especiales.
